                      ...
                      {loadingLeadsData ? (
                        ...
                        <>
                          ...
                          {metric.rating_history && metric.rating_history.length > 0 && (
                            <span
                              className="inline-flex items-center justify-center w-4 h-4 text-xs font-bold text-white bg-blue-500 rounded-full cursor-pointer hover:bg-blue-600 transition-colors flex-shrink-0"
                              onClick={(e) => {
                                e.stopPropagation();
                                setOpenRatingTooltip(openRatingTooltip === index ? null : index);
                              }}
                              title="История рейтинга за 3 месяца"
                            >
                              i
                            </span>
                          )}
